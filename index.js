...
const pizzasNombre = pizzas.forEach((pizza) => {
  console.log(`${pizza.nombre}, $${pizza.precio}`);
});

// d) Todos los ingredientes de cada pizza
// (En cada iteración imprimir los ingredientes de la pizza que se esta recorriendo). Ayuda: van a tener que realizar dos recorridos,
